...
abstract class AppLocalizations {
  ...
  /// In es, this message translates to:
  /// **'Intensidad SRS'**
  String get srsIntensityTitle;

  /// No description provided for @srsIntensitySubtitle.
  ///
  /// In es, this message translates to:
  /// **'Ajusta la frecuencia de repaso entre sesiones.'**
  String get srsIntensitySubtitle;

  /// No description provided for @microphoneModeTitle.
  ///
  /// In es, this message translates to:
  /// **'Modo canto (experimental)'**
  String get microphoneModeTitle;

  /// No description provided for @microphoneModeWebHint.
  ///
  /// In es, this message translates to:
  /// **'Canta o tararea la nota. El audio no se sube a internet.'**
  String get microphoneModeWebHint;

  /// No description provided for @microphoneModeMobileHint.
  ///
  /// In es, this message translates to:
  /// **'Disponible en web. En movil usa piano o texto por ahora.'**
  String get microphoneModeMobileHint;

  /// No description provided for @microphoneListen.
  ///
  /// In es, this message translates to:
  /// **'Escuchar nota'**
  String get microphoneListen;
